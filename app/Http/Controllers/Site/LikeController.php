...
class LikeController extends Controller
{
    ...
    public function vote(Request $request)
    {
    	...
    	$totalLike = TotalItemLike::where('item_id', $itemId)->first();
		...
		$like = ItemLike::where(['user_id' => $userId, 'item_id' => $itemId])->first();
		...
		if ($like != null) {
			...
			$like = new ItemLike;	// create new like object if previous vote not exists
		}
